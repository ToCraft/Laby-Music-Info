...
public abstract class AbstractService {
  ...
  @Internal
  @NotNull
  private static String getResponse(@NotNull Map<String, String> header, @NotNull URL url)
      throws IOException {
  ...
  protected static @NotNull String getStringFromInputStream(InputStream inputStream)
      throws IOException {
